...
public class LoadingFragmentDialog extends DialogFragment{
	...
	private LayoutInflater layouInflater = null;
	
	public LoadingFragmentDialog(){
		super();
	}
	
	public LoadingFragmentDialog(LayoutInflater layoutInflater){
		super();
	...
	public Dialog onCreateDialog(Bundle savedInstanceState) {
		...
		layout = layouInflater.inflate(R.layout.base_dialog_loading, null);
